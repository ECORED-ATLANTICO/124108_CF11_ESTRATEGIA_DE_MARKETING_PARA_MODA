export default {
  ...
  menuPrincipal: {
    ...
    subMenu: [
      ...
      },
      {
        ...
        download: 'downloads/124108_CF11_DU.pdf',
      },
      {
  ...
  referencias: [
    {
      referencia:
        'Codina, M. (2004). <em>Crear moda, hacer cultura</em>. Ars Brevis, (10), 43-62.',
      link:
    ...
    {
      referencia:
        'Estanyol, E. (2020). <em>Los eventos de moda en tiempos de COVID-19. COMeIN, (103)</em>.',
